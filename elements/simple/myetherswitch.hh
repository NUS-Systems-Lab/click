#ifndef CLICK_MYETHERSWITCH_HH
#define CLICK_MYETHERSWITCH_HH
...
class MyEtherSwitch : public Element { public:

  MyEtherSwitch() CLICK_COLD;
  ~MyEtherSwitch() CLICK_COLD;

  const char *class_name() const		{ return "MyEtherSwitch"; }
...
inline
MyEtherSwitch::AddrInfo::AddrInfo(int p, const Timestamp& s)
    : port(p), stamp(s)
{
}
